...
type ExecuteFunction = (player: alt.Player, args: string[]) => Promise<void>;
...
export class CommandHandler {
    ...
    static handlers: { [command: string]: (player: alt.Player, args: string[]) => void; } = {};
    ...
    async executeCommand(player: alt.Player, args: string[]) {
